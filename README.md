...
Avec quelques modifications, le script réalise les choses suivantes:
  ...
  - Les boutons radio permettant de choisir tous les épisodes ou uniquement les épisodes gratuits sont remplacés par deux cases à cocher permettant de choisir si on souhaite filtrer les versions (sur la base du tableau de paramètres) ainsi que de se limiter aux séries indiquées avec le flag de suivi ou le flag avant première (qui respectent le filtre de la langue).

Résultat, l'interface est épurée, avec uniquement les séries et versions que l'on souhaite suivre ainsi que le avant première pour ne pas manquer une nouvelle série.
